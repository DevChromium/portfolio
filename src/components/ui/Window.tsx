...
export const Window = ({ title, children, className }: WindowProps) => {
    return (
      <div className={className}>
        <section className="h-full w-full bg-zinc-900/25 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-zinc-900/95 flex flex-col gap-4 max-w-2xl">
